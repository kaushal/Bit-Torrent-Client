...
public class Torrent implements Runnable {
    ...
    public Object getPeers() throws IOException, BencodingException {
        ...
        URL url = new URL(this.torrentInfo.announce_url.toString() + "?info_hash=" + this.encodedInfoHash + "&peer_id=" + "EKW45678901234567890" + "&port=6881&uploaded=0&downloaded=0&left=1024");
